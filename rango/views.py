...
def index(request):
    #Line added first to test cookies. 
...
def about(request):
    # Lines added for cookie testing (Chapter 10)
...
# Helper function for tracking cookies
def visitor_cookie_handler(request):
    ...
    if (datetime.now() - last_visit_time).days > 0:
        visits = visits + 1
        # Update the last cookie visit now that we have updated the count
